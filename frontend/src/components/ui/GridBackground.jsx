...
export function GridBackground({ children }) {
  return (
    <div className="min-h-screen w-full bg-[#030303] relative flex flex-col items-center justify-start antialiased overflow-x-hidden">
      <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#16161d_1px,transparent_1px),linear-gradient(to_bottom,#16161d_1px,transparent_1px)] bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,#000_50%,transparent_100%)] opacity-70" />
